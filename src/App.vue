...
const currencyMap = ["btccny", "ethcny", "dgdcny", "btscny", "sccny", "etccny", "1stcny", "repcny", "anscny", "zeccny", "gntcny", "qtumcny", "gxscny", "eoscny", "sntcny", "bcccny", "omgcny", "lun", 'pay'].reduce((result, next, index) => {
  const key = index + 1
  result[key] = next
  return result
}, {})
